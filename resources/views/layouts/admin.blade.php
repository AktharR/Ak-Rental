        ...
        <div class="row">
            ...
            <div class="col pt-2 d-flex justify-content-end ">
                <ul class="list-inline list-inline-item pe-5">
                    <li class="list-inline-item"><a class="text-white text-decoration-none" href="{{ route('admin.dashboard') }}">Home</a>
                    </li>
    ...
    <div class="row p-5">
        <div class="col-md-2">
            ...
            <ul class="nav navbar-nav">
                <li><i class="fa-regular fa-square-plus"></i><a href="{{ route('admin.addCar') }}"
                        class="text-decoration-none text-primary-emphasis"> Add car </a></li>
                <li></li>
                <li>
                    <hr>
                </li>
                <li><i class="fa-regular fa-eye"></i><a href="{{ route('admin.viewCar') }}"
                        class="text-decoration-none text-primary-emphasis"> view car</a></li>
                <li>
                    <hr>
                </li>
            ...
            <h4><i class="fa-solid fa-car"></i> Cutomers</h4>
            <hr>
            <ul class="nav navbar-nav">
                <li><i class="fa-solid fa-user"></i> <a href="{{ route('admin.bookingDetails') }}"
